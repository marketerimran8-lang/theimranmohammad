    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-transparent">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
                ...
                >
                    <h1 className="text-5xl sm:text-7xl md:text-8xl font-bold mb-8 tracking-tighter leading-tight font-serif select-none">
                            ...
                            >
                                {word.split("").map((letter, letterIndex) => (
                                    <motion.span
                                        ...
                                        bg-gradient-to-r from-neutral-200 to-neutral-400/80"
                                    >
                                        {letter}
                                    </motion.span>
                                ))}
